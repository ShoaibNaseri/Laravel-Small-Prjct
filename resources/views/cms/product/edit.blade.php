...
<div class="main-card mb-3 card">
    <div class="card-body">
        ...
        <form id="signupForm" method="post" action="{{route('product.update', $product)}}" enctype="multipart/form-data" novalidate="novalidate">
        @csrf
            <div class="position-relative row form-group">
                <label for="title" class="col-sm-2 col-form-label">Proudct Name</label>
                <div class="col-sm-10">
                    <input name="name" id="title" placeholder="Product Name" type="text" class="form-control" value="{{$product->name}}" required maxlength="191">
            ...
            <div class="position-relative row form-group">
                ...
                <div class="col-sm-10">
                    <input name="trad_name" id="tname" placeholder="Trade Name" type="text" class="form-control" value="{{$product->trad_name}}" required maxlength="191">
            ...
            <div class="position-relative row form-group">
                ...
                <div class="col-sm-10">
                    <input name="country" id="country" placeholder="Country Name" type="text" class="form-control" value="{{$product->country}}" required maxlength="191">
          ...
          <div class="position-relative row form-group">
                ...
                <div class="col-sm-10">
                    <input name="expiry_date" id="date" placeholder="Product's expiry date" type="text" class="form-control" value="{{$product->expiry_date}}" required maxlength="191">
            ...
            <div class="position-relative row form-group">
                ...
                <div class="col-sm-10">
                    <input name="company" id="company" placeholder="Company name" type="text" class="form-control" value="{{$product->company}}" required maxlength="191">
            ...
            <div class="position-relative row form-group">
                ...
                <div class="col-sm-10">
                    <textarea name="description" id="description" class="form-control tiny" required>{{$product->detail}}</textarea>
            ...
            <div class="position-relative row form-group">
                ...
                <div class="col-sm-10">
                    <input name="price" id="company" placeholder="price" type="text" class="form-control" value="{{$product->price}}" required maxlength="191">
