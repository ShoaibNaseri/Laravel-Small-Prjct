...
<head>
    ...
    <link href="{{url('')}}/cms/css/main.d810cf0ae7f39f28f336.css" rel="stylesheet">
</head>
                                ...
                                <div class="widget-content-left">
                                    <div class="btn-group">
                                        <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                                            class="p-0 btn">
                                            <img width="42" class="rounded-circle" src="{{url('')}}/cms/images/avatars/1.jpg"
                                                alt="">
                                            ...
                                            <div class="dropdown-menu-header">
                                                <div class="dropdown-menu-header-inner bg-info">
                                                    <div class="menu-header-image opacity-2"
                                                        style="background-image: url('<?php echo url('') ?>/cms/images/dropdown-header/city3.jpg');">
                                                    </div>
                                                            ...
                                                            <div class="widget-content-wrapper">
                                                                <div class="widget-content-left mr-3">
                                                                    <img width="42" class="rounded-circle"
                                                                        src="{{url('')}}/cms/images/avatars/1.jpg" alt="">
                                                                </div>
                                                                <div class="widget-content-left">
                                                                ...
                                                                <div class="widget-content-right mr-2">
                                                                    <a href="{{route('admin.logout')}}"
                                                                        class="btn btn-pill btn-shadow btn-shine btn btn-focus">Logout</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                ...
                <div class="scrollbar-sidebar">
                    <div class="app-sidebar__inner">
                        <ul class="vertical-nav-menu">
                            ...
                            <a href="#">
                                <i class="metismenu-icon pe-7s-monitor"></i>Webpage
                                <i class="metismenu-state-icon pe-7s-angle-down caret-left"></i>
                            </a>
                            <ul>
                            ...
                            <a href="#">
                                <i class="metismenu-icon pe-7s-ticket"></i>Products
                                <i class="metismenu-state-icon pe-7s-angle-down caret-left"></i>
                            </a>
                            <ul>
                                ...
                                <li>
                                    <a href="{{route('category.index')}}" class="">
                                        <i class="metismenu-icon"></i>Medicine types
                                    </a>
                                </li>
                               
                                <li>
                                    <a href="{{route('product.index')}}" >
                                        <i class="metismenu-icon"></i>Medicine
                                    </a>
                                </li>
