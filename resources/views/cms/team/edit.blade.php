...
<div class="main-card mb-3 card">
    <div class="card-body">
        ...
        <form id="" method="post" action="{{route('team.update', $team)}}" enctype="multipart/form-data" novalidate="novalidate">
        @csrf
            <div class="position-relative row form-group">
                <label for="title_en" class="col-sm-2 col-form-label">Name</label>
                <div class="col-sm-10">
                    <input name="name" id="title_en" placeholder="Member Name" type="text" class="form-control" value="{{$team->name}}" required maxlength="191">
            ...
            <div class="position-relative row form-group">
                ...
                <div class="col-sm-10">
                    <input name="position" id="title" placeholder="Position in Company" type="text" class="form-control" value="{{$team->position}}" required maxlength="191">
            ...
            <div class="position-relative row form-group">
                ...
                <div class="col-sm-10">
                    <input name="facebook" id="facebook" placeholder="Position in Company" type="text" class="form-control" value="{{$team->facebook}}" required maxlength="191">
            ...
            <div class="position-relative row form-group">
                ...
                <div class="col-sm-10">
                    <input name="instagram" id="instagram" placeholder="Position in Company" type="text" class="form-control" value="{{$team->instagram}}" required maxlength="191">
            ...
            <div class="position-relative row form-group">
                ...
                <div class="col-sm-10">
                    <input name="twitter" id="twitter" placeholder="Position in Company" type="text" class="form-control" value="{{$team->twitter}}" required maxlength="191">
