...
<div class="main-card mb-3 card">
    <div class="card-body">
        ...
        <form id="" method="post" action="{{route('service.update',$service)}}" enctype="multipart/form-data" novalidate="novalidate">
        @csrf
            <div class="position-relative row form-group">
                <label for="title_en" class="col-sm-2 col-form-label">Title</label>
                <div class="col-sm-10">
                    <input name="title" id="title_en" placeholder="Service Title" type="text" class="form-control" value="{{$service->title}}" required maxlength="191">
            ...
            <div class="position-relative row form-group">
                ...
                <div class="col-sm-10">
                    <textarea name="description" id="description" placeholder="Description" class="form-control tiny" required>{{$service->description}}</textarea>
