...
<div class="app-page-title">
    <div class="page-title-wrapper">
        <div class="page-title-heading">
            ...
            <div>Medicine Categories
                <div class="page-title-subheading">This page displays all the medicine categories.</div>
...
<div class="row">
   ...
   <div class="col-md-4">
        <div class="main-card mb-3 card">
            <div class="card-body">
                <h5 class="card-title">{{$num++}}.{{$category->category_name}}</h5>
            </div>
...
<div class="row p-4 ">
        <div class="col-md-12 text-center"><p class="small text-danger">We have {{$num-1}} medicine types</p></div>
    </div>
@endsection